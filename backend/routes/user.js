...
router.get("/:id/posts", auth, postCtrl.getPostsByUserId);      //étape à valider pour l"obtention de tous les posts d"un utilisateur
router.put("/", auth, multer, userCtrl.modifyUser);      //étape à valider pour modifier un utilisateur
router.delete("/", auth, userCtrl.deleteUser);       //étape à valider pour supprimer un utilisateur
