...
import Deletecom from './Deletecom.jsx'
...
const deleteCom = commentId => {
    ...
    newComments = newComments.filter(post => post.id !== commentId)
                ...
                <span>
                    {
                        comments && comments.map(comment => (
                            <div key={comment.id}>
                                ...
                                {userId === comment.userId ? <div className="date"><Deletecom commentId={comment.id} delComments={deleteCom} /></div> : false}
